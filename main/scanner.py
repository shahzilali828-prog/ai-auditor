...
class GDPRScanner:
    def __init__(self):
        ...
        self.compliance_checks = {
            "gdpr_contact": {
                "keywords": ["dpo@", "privacy@", "data protection officer", "contact us"],
                "score": 1,
                "error_msg": "CRITICAL: No Data Protection Contact found (GDPR Art. 13)"
            },
            "erasure": {
                "keywords": ["right to erasure", "delete your data", "request deletion", "remove your information"],
                "score": 1,
                "error_msg": "CRITICAL: No 'Right to Erasure' clause found (GDPR Art. 17)"
            },
            "ccpa_sells": {
                "keywords": ["do not sell my", "opt-out", "selling your personal information"],
                "score": 1,
    ...
    def fetch_privacy_policy(self, url):
        ...
        try:
            ...
            # 1. Try to find a link that says "Privacy"
            privacy_link = None
